 ...
 * @brief Configuration of compile-time options, limits, db format, etc.
 * @version 3.3
 * @date 2021-01-04
 * 
...
/** 
 * @attention Do not change anything unless you are certain you know what it does.
 * General user-definable compile-time options can be found in the configure script.
 * 
 */
