...
char *gdbm_strerror ( gdbm_error gdbmerrno )
{
    ...
    case GDBM_CANT_BE_READER:
        return "Can't be reader";

    case GDBM_CANT_BE_WRITER:
        return "Can't be writer";

    case GDBM_READER_CANT_DELETE:
        return "Reader can't delete";

    case GDBM_READER_CANT_STORE:
        return "Reader can't store";

    case GDBM_READER_CANT_REORGANIZE:
        return "Reader can't reorganize";
    ...
    case GDBM_ILLEGAL_DATA:
        return "Illegal data";

    case GDBM_OPT_ALREADY_SET:
        return "Option already set";

    case GDBM_OPT_ILLEGAL:
