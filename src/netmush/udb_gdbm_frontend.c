/**
 * @file udb_gdbm_frontend.c
 * @author TinyMUSH development team (https://github.com/TinyMUSH)
 * @brief GDBM-only command-line helpers (dbconvert, recover usage)
 * @version 4.0
 *
 * Handles GDBM-specific dbconvert and recover flows so other files stay backend-agnostic.
 */
