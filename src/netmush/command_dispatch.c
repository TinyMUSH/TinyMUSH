...
// Handler function pointers - cache to avoid repeated casts during dispatch
static void (*handler_cs_no_args)(dbref, dbref, int);
static void (*handler_cs_one_args)(dbref, dbref, int, char *);
static void (*handler_cs_one_args_unparse)(dbref, char *);
static void (*handler_cs_one_args_cmdargs)(dbref, dbref, int, char *, char *[], int);
static void (*handler_cs_two_args)(dbref, dbref, int, char *, char *);
static void (*handler_cs_two_args_cmdargs)(dbref, dbref, int, char *, char *, char *[], int);
static void (*handler_cs_two_args_argv)(dbref, dbref, int, char *, char *[], int);
static void (*handler_cs_two_args_cmdargs_argv)(dbref, dbref, int, char *, char *[], int, char *[], int);
