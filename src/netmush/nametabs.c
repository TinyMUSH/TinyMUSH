...
CMDENT command_table[] = {
    ...
    {(char *)"@clone", clone_sw, CA_NO_SLAVE | CA_GBL_BUILD | CA_CONTENTS | CA_NO_GUEST, 0, CS_TWO_ARG | CS_INTERP | CS_FUNCTION, NULL, NULL, NULL, {create_do_clone}},
    ...
    {(char *)"@create", NULL, CA_NO_SLAVE | CA_GBL_BUILD | CA_CONTENTS | CA_NO_GUEST, 0, CS_TWO_ARG | CS_INTERP, NULL, NULL, NULL, {create_do_create}},
    ...
    {(char *)"@destroy", destroy_sw, CA_NO_SLAVE | CA_NO_GUEST | CA_GBL_BUILD, DEST_ONE, CS_ONE_ARG | CS_INTERP | CS_FUNCTION, NULL, NULL, NULL, {create_do_destroy}},
    {(char *)"@dig", dig_sw, CA_NO_SLAVE | CA_NO_GUEST | CA_GBL_BUILD, 0, CS_TWO_ARG | CS_ARGV | CS_INTERP, NULL, NULL, NULL, {create_do_dig}},
    ...
    {(char *)"@drain", NULL, CA_GBL_INTERP | CA_NO_SLAVE | CA_NO_GUEST, NFY_DRAIN, CS_TWO_ARG, NULL, NULL, NULL, {cque_do_notify}},
    ...
    {(char *)"@halt", halt_sw, CA_NO_SLAVE, 0, CS_ONE_ARG | CS_INTERP, NULL, NULL, NULL, {cque_do_halt}},
    ...
    {(char *)"@kick", NULL, CA_WIZARD, QUEUE_KICK, CS_ONE_ARG | CS_INTERP, NULL, NULL, NULL, {cque_do_queue}},
    {(char *)"@last", NULL, CA_NO_GUEST, 0, CS_ONE_ARG | CS_INTERP, NULL, NULL, NULL, {do_last}},
    {(char *)"@link", NULL, CA_NO_SLAVE | CA_GBL_BUILD | CA_NO_GUEST, 0, CS_TWO_ARG | CS_INTERP | CS_FUNCTION, NULL, NULL, NULL, {create_do_link}},
    ...
    {(char *)"@notify", notify_sw, CA_GBL_INTERP | CA_NO_SLAVE | CA_NO_GUEST, 0, CS_TWO_ARG, NULL, NULL, NULL, {cque_do_notify}},
    {(char *)"@oemit", oemit_sw, CA_LOCATION | CA_NO_GUEST | CA_NO_SLAVE, PEMIT_OEMIT, CS_TWO_ARG | CS_INTERP, NULL, NULL, NULL, {do_pemit}},
    {(char *)"@open", open_sw, CA_NO_SLAVE | CA_GBL_BUILD | CA_CONTENTS | CA_NO_GUEST, 0, CS_TWO_ARG | CS_ARGV | CS_INTERP, NULL, NULL, NULL, {create_do_open}},
    {(char *)"@parent", NULL, CA_NO_SLAVE | CA_GBL_BUILD | CA_NO_GUEST, 0, CS_TWO_ARG | CS_FUNCTION, NULL, NULL, NULL, {create_do_parent}},
    {(char *)"@password", NULL, CA_NO_GUEST, PASS_MINE, CS_TWO_ARG, NULL, NULL, NULL, {do_password}},
    {(char *)"@pcreate", NULL, CA_WIZARD | CA_GBL_BUILD, PCRE_PLAYER, CS_TWO_ARG, NULL, NULL, NULL, {create_do_pcreate}},
    ...
    {(char *)"@ps", ps_sw, CA_PUBLIC, 0, CS_ONE_ARG | CS_INTERP, NULL, NULL, NULL, {cque_do_ps}},
    ...
    {(char *)"@robot", NULL, CA_NO_SLAVE | CA_GBL_BUILD | CA_NO_GUEST | CA_PLAYER, PCRE_ROBOT, CS_TWO_ARG, NULL, NULL, NULL, {create_do_pcreate}},
    ...
    {(char *)"@wait", wait_sw, CA_GBL_INTERP, 0, CS_TWO_ARG | CS_CMDARG | CS_NOINTERP | CS_STRIP_AROUND, NULL, NULL, NULL, {cque_do_wait}},
