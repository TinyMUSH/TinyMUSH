...
#define SAFE_LB_STR(s, b, p) __xsafestrncat(b, p, s, strlen(s), LBUF_SIZE - 1)
#define SAFE_SB_STR(s, b, p) __xsafestrncat(b, p, s, strlen(s), SBUF_SIZE - 1)
#define SAFE_MB_STR(s, b, p) __xsafestrncat(b, p, s, strlen(s), MBUF_SIZE - 1)
