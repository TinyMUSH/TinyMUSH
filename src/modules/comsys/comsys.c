...
void mod_comsys_init(void)
{
    ...
    str = XMALLOC(MBUF_SIZE, "mod_comsys_init.str");
    ...
    mod_comsys_version.copyright = XSTRDUP("Copyright (C) 2012 TinyMUSH development team.", "mod_comsys_init.mod_comsys_version.copyright");
    XFREE(str);
