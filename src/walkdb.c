...
static void
bind_and_queue(player, cause, action, argstr, cargs, ncargs, number, now)
dbref player, cause;
...
void
do_dolist(player, cause, key, list, command, cargs, ncargs)
dbref player, cause;
...
void
do_stats(player, cause, key, name)
dbref player, cause;
...
int
chown_all(from_player, to_player, acting_player, key)
...
void
do_chownall(player, cause, key, from, to)
dbref player, cause;
...
int
search_setup(player, searchfor, parm)
dbref player;
...
void
search_perform(player, cause, parm)
dbref player, cause;
...
void
do_search(player, cause, key, arg)
dbref player, cause;
...
void
do_floaters(player, cause, key, name)
dbref player, cause;
...
void
do_apply_marked(player, cause, key, command, cargs, ncargs)
dbref player, cause;
