...
#define	NULL	0
     ...
     */
    extern __ptr_t calloc __P((__malloc_size_t __nmemb,
...
#define ADDRESS(B)	((__ptr_t) (((B) - 1) * BLOCKSIZE + _heapbase))
    ...
    extern __ptr_t(*__realloc_hook) __P((__ptr_t __ptr,
                                         __malloc_size_t __size));
     ...
     */
    extern __ptr_t r_alloc __P((__ptr_t * __handleptr,
                                __malloc_size_t __size));
     ...
     */
    extern __ptr_t r_re_alloc __P((__ptr_t * __handleptr,
                                   __malloc_size_t __size));
...
__malloc_size_t size;
{
    ...
    {
        newsize = heapsize;
        while ((__malloc_size_t) BLOCK((char *)result + size) >
                newsize)
            newsize *= 2;
        ...
        memcpy((void *)newinfo, (const void *)_heapinfo,
...
__malloc_size_t size;
{
    ...
    if (adj != 0)
    {
        ...
        if (l == NULL)
        {
            l = (struct alignlist *)malloc(sizeof(struct
                                                  alignlist));
            if (l == NULL)
            {
                free(result);
